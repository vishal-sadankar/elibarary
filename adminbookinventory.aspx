<%@ Page Title="Book Inventory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="furniture.adminbookinventory" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Book Cost(Per Unit)" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-4">
                                <label>Pages</label>
