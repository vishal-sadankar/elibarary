<%@ Page Title="Author Management" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminauthormanagement.aspx.cs" Inherits="furniture.adminauthormanagement" %>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtname"
                                        placeholder="Auther ID"></asp:TextBox>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" CssClass="form-control" ID="TextBox1"
                                        placeholder="Auther Name"></asp:TextBox>
                                </div>
                            </div>
                        </div>
